...
import { getTrendingProducts, getNewArrivals } from "@/data/products";
...
const Index = () => (
  <main>
    ...
    <ProductScroller title="Trending Now" subtitle="Most loved by parents this week" products={getTrendingProducts()} />
    <ProductScroller title="New Arrivals" subtitle="Fresh picks just for you" products={getNewArrivals()} />
