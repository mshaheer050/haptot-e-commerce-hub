      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
        ...
        <div className="col-span-2 md:col-span-1 space-y-4">
          ...
          <div className="flex gap-2.5">
            <a href="https://www.instagram.com/haptot.in" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors">
              <Instagram className="w-3.5 h-3.5" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors">
        ...
        <div>
          ...
          <div className="space-y-2.5">
            <a href="mailto:haptot.store@gmail.com" className="flex items-center gap-2 text-sm text-primary-foreground/60 hover:text-primary-foreground transition-colors">
              <Mail className="w-3.5 h-3.5" />
              haptot.store@gmail.com
            </a>
            <a href="tel:+919497809094" className="flex items-center gap-2 text-sm text-primary-foreground/60 hover:text-primary-foreground transition-colors">
